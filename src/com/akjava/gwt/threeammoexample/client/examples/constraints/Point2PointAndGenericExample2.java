...
public class Point2PointAndGenericExample2 extends AbstractAmmoExample{

	@Override
	public String getName() {
		return "Point2PointAndGenericConstraint2";
	}

	@Override
	public String getTokenKey() {
		return "point2generic2";
	}
 ...
 */
	...
	protected void makeAmmoObjects() {
		...
		ballPosition=THREE.Vector3(0, 20, 0);
		ball2Position=THREE.Vector3(5, 20, 0);
		ball3Position=THREE.Vector3(10, 20, 0);
		pivot0Position=THREE.Vector3(0, 20, 0);
		...
		controlerRootPanel.add(new Label("ball2"));
		...
		controlerRootPanel.add(new Label("ball3"));
		SimpleVector3Editor ball3PositionEditor=new SimpleVector3Editor(new SimpleVector3EditorListener() {
			@Override
			public void onValueChanged(Vector3 value) {
				ball3Position.copy(value);
				resetProperties();
				
				initConstraint();
			}
		});
		controlerRootPanel.add(ball3PositionEditor);
		ball3PositionEditor.setValue(ball3Position);
	...
	private ConstraintAndLine constraint3;
	public void initConstraint(){
		...
		if(constraint3!=null){
			ammoControler.destroyConstraintAndLine(constraint3);
		}
		frameInB.getOrigin().copy(ball3Position.clone().sub(ball2Position).multiplyScalar(-1));
		constraint3=ammoControler.createGeneric6DofConstraint(ball2, ball3, frameInA, frameInB, false);
	...
	public void resetProperties(){
		...
		resetProperties(ball3,ball3Position);
	}
